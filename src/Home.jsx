        ...
        <div className='main'>
            ...
            <div className='footer1'>
                ...
                <div className='nav1'>
                    ...
                    <caption>Help Centre</caption>
                    <caption>Gift Cards</caption>
                    <caption>Media Centre</caption><br />
                </div>

                <div className='nav2'>
                    <caption>Investor Relations</caption>
                    <div className='j'>
                    <caption>Jobs</caption>
                    </div>
                    <caption className='term'>Terms of use</caption>
                    <caption>Privacy</caption><br />
                </div>

                <div className='nav3'>
                    <caption>legal Notices</caption>
                    <caption className='coki'>Cookies Preferences</caption>
                    <caption className='coo'>Coorporate Information</caption>
                    <caption>Contact us</caption><br />
                </div>

                <div className='outerSquare'>
                    <div className='innerSquare'>
                        <caption>Service Code</caption>
                    </div>
                </div>
